    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_ifabrealestate_domain_model_attachmentgroupvaluerel}.{#pid}=###CURRENT_PID### AND {#tx_ifabrealestate_domain_model_attachmentgroupvaluerel}.{#sys_language_uid} IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
        ...
        'name' => [
            'exclude' => true,
            'label' => 'LLL:EXT:ifab_realestate/Resources/Private/Language/locallang_db.xlf:tx_ifabrealestate_domain_model_attachmentgroupvalue.name',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim'
